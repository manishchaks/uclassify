...
describe "UClassify Query" do
  it "Should be able to add classifier to a query" do
    ...
    query.add_classifier('classifier_name','text_id').add_text ('text_id','text')
  ...
  it "Should be able triggery classifier query with multiple unclassified texts" do
    ...
    <uclassify xmlns=\"http://api.uclassify.com/1/RequestSchema\" version=\"1.0.1\">
      ...
      <readCalls readApiKey=\"YOUR_READ_API_KEY_HERE\">
        <classify id=\"fantasylanguage_id\" classifierName=\"FantasyLanguage\" textId=\"UnknownFantasyText1\"/>
        <classify id=\"fantasylanguage_id\" classifierName=\"FantasyLanguage\" textId=\"UnknownFantasyText2\"/>
      </readCalls>
    </uclassify>"
     ...
     document = Nokogiri::XML::Document.new
      ...
      query.add_classifier('FantasyLanguage','UnknownFantasyText1')
      query.add_classifier('FantasyLanguage','UnknownFantasyText2')
      xml_cmp(query.get_query_string,expected_string).should == true   
  end
end
