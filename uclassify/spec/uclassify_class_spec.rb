...
describe "UClassify Create Class" do
  it "Should be able to create a simple class" do
    ...
    create_class = UClassifyClass.new("DUMMY_CLASS_ID","DUMMY_CLASS_NAME")
   ...
   create_class.to_xml_node(document).to_xml.should =="<addClass id=\"DUMMY_CLASS_ID\" className=\"DUMMY_CLASS_NAME\"/>"
  end
end
